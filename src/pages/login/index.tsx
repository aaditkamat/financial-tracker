...
const Login = (): React.ReactElement => {
  ...
  return (
    <div className={styles["login"]} data-testid={testids.login.form}>
      <p className={styles["heading"]} data-testid={testids.login.title}> Login </p>
      <Box width='100%' p={8} borderWidth='1px' borderRadius='lg' overflow='hidden'>
        <FormControl isInvalid={isEmailError || isPasswordError}>
          <VStack spacing={4} align='stretch'>
            <FormLabel>Email</FormLabel>
            <Input type="email" value={email} onChange={handleEmailChange} data-testid={testids.login.email}/>
